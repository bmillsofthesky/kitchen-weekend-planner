...
Defines the per-meal theme data model and editing experience, covering cover images, rich-text description, design details with purchasable needed items, skit entries, and reference image galleries.
