...
#### Scenario: Import overwrites existing configuration
- **WHEN** a user imports a configuration file for a movement that already exists
- **THEN** the existing configuration SHALL be overwritten with the imported data
